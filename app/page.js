...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex flex-row border items-center">
      {modal && (
        <div className="absolute flex flex-col border border-red-500 bg-blue-800 rounded-3xl w-[50vh] h-[60vh] my-auto mx-[80vh]">
          <form onSubmit={handleCreateTask} className="p-4 flex flex-col gap-2">
            ...
            <button
              type="submit"
              className="self-start mx-8 my-4 border px-3 py-2 bg-green-400 rounded-2xl"
            >
              Create
            </button>
          </form>
